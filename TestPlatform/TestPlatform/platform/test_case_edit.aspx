...
<head runat="server">
    ...
    <title>编辑测试项目 - 测试项目 - 测试管理 - 软件测试平台</title>
    ...
    <div class="container" runat="server">
        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading"><b id="B1" runat="server">测试管理 > 测试项目 > 编辑测试项目</b></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" runat="server" class="form-control" id="test_case_name" style="font-weight: bold;" placeholder="测试项目名称" required="required" />
                                    </div>
                                    <div class="form-group">
