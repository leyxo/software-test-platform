                ...
                <div class="panel-body" id="Div1" runat="server">
                    ...
                    <div style="max-width: 100%;">
                        <form id="form1" role="form" runat="server">
                            <h4><strong><span id="Title_Test_Name" runat="server">系统名称</span> <span id="Title_Test_version" runat="server"></span></strong></h4>
                            <br />
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="test_case_name">测试项目名称</label>
                                        <input type="text" runat="server" class="form-control" id="test_case_name" style="font-weight: bold;" placeholder="必填" required="required" />
                                    </div>
                                    <div class="form-group">
