<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="system_manage_personnel_add.aspx.cs" Inherits="TestPlatform.platform.system_manage_personnel_add" %>
    ...
    <div class="container" runat="server">
        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading"><b id="B1" runat="server">系统管理 > 人员管理 > 新增人员</b></div>
                        ...
                        <form id="form1" role="form" runat="server">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <br />
                                    <div class="input-group">
                                        <span class="input-group-addon glyphicon glyphicon-lock" id="password_icon" style="position: static"></span>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" runat="server" class="form-control" id="password_confirm" placeholder="确认密码"  required="required" />
                                    </div>
                                    <br />
                                    <div class="input-group">
                                        <span class="input-group-addon glyphicon glyphicon-envelope" id="emil_icon" style="position: static"></span>
                                        <input type="text" runat="server" class="form-control" id="email" placeholder="邮箱" />
                                    </div>
                                    <br />
                                    <div class="input-group">
