...
Session["current_user_department_id"]	// 用户所属机构ID
Session["current_user_department_name"]	// 用户所属机构名称 (不可靠)
...
Session["editing_department_id"]		// 用户所属机构ID
Session["editing_test_id"]				// 测试系统ID
Session["editing_issuetype_id"]			// 错误ID
Session["editing_test_case_id"]			// 测试项目ID
Session["editing_test_version_id"]      // 测试版本ID

[当前测试项目]
Session["current_test_id"]				// 测试系统ID (用于保存"测试项目"页下拉列表当前选中项，下同)
