            ...
            <div class="panel-body" style="min-height:initial">
                <form id="form1" method="post" role="form" runat="server">
                    <div class="input-group">
                        ...
                        <input type="text" runat="server" class="form-control" id="username" placeholder="用户名" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" required="required" maxlength="16" autofocus="autofocus" />
                    </div>
                    <br />
                    <div class="input-group">
