<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="basedata_manage_test_version_add.aspx.cs" Inherits="TestPlatform.platform.basedata_manage_test_version_add" %>
    ...
    <div class="container" runat="server">
        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading"><b id="B1" runat="server">测试管理 > 测试版本 > 新增版本</b></div>
                <div class="panel-body" id="Div1" runat="server">

                    <%--主体内容--%>
                    <div style="max-width: 400px;">
                        <h4><strong>新增版本 - <span id="Title_Test_Name" runat="server">系统名称</span></strong></h4>
                        <br />
                        <form id="form1" role="form" runat="server">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group input-daterange">
                                    <input type="text" id="start_time" runat="server" placeholder="测试起始日期" readonly="readonly" style="background-color:white; text-align:left;" class="form-control datepicker" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                                    <div class="input-group-addon">至</div>
                                    <input type="text" id="end_time" runat="server" placeholder="测试结束日期" readonly="readonly" style="background-color:white; text-align:left;" class="form-control datepicker" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                                </div>
                            </div>
                            <br />
                            <div class="input-group">
