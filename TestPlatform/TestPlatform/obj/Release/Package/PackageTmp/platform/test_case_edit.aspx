<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test_case_edit.aspx.cs" Inherits="TestPlatform.platform.test_case_edit" %>
...
<head runat="server">
    ...
    <title>编辑测试记录 - 测试记录 - 测试管理 - 软件测试平台</title>
    ...
    <div class="container" runat="server">
        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading"><b id="B1" runat="server">测试管理 > 测试记录 > 编辑测试记录</b></div>
                <div class="panel-body" id="Div1" runat="server">

                    <%--主体内容--%>
                    <div style="max-width: 100%;">
                        <form id="form1" role="form" runat="server">
                            <h4><strong><span id="Title_Test_Name" runat="server">系统名称</span> <span id="Title_Test_version" runat="server"></span></span></strong></h4>
                            <br />
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="test_case_name">测试记录名称</label>
                                        <input type="text" runat="server" class="form-control" id="test_case_name" style="font-weight: bold;" placeholder="测试记录名称" required="required" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" runat="server" class="form-control" id="test_case_times" style="max-width: 80px;" placeholder="" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="test_case_type">错误类型</label>
                                                <asp:DropDownList ID="DropDownList_type" runat="server" DataSourceID="SqlDataSource_register_type" DataTextField="name" DataValueField="id" Height="34px" Width="128px"></asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource_register_type" runat="server" ConnectionString="<%$ ConnectionStrings:webConnectionString %>" SelectCommand="SELECT * FROM [test_issue_type]"></asp:SqlDataSource>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
